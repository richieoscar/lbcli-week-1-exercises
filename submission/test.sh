...
SIMPLE_DESCRIPTOR=$(bitcoin-cli -regtest -rpcwallet=treasurewallet getaddressinfo "$NEW_TAPROOT_ADDR" | jq -r '.desc')
...
# WRITE YOUR SOLUTION BELOW:
DERIVED_ADDR_RAW=$(bitcoin-cli deriveaddress "$TAPROOT_DESCRIPTOR")
